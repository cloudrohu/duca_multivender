...
class Slide_ContentAdmin(admin.ModelAdmin):
    list_display = ['title','title_1', 'title_2','title_3','title_4','featured_project','create_at','update_at',]


admin.site.register(Slide_Content,Slide_ContentAdmin)
admin.site.register(Setting,SettingtAdmin)
admin.site.register(ContactMessage,ContactMessageAdmin)
admin.site.register(Offer,OfferAdmin)
admin.site.register(Slider,SliderAdmin)
admin.site.register(Banner,SliderAdmin)